...
public class COFTokenDto {
    ...
    public COFTokenDto(String userId, String merchantId, String merchantTxnRefNo, Date dateTime, String txnType, String mbbTxnRefNo, String statusCode, String statusDec, String tokenRefNo, String tokenValidity, Integer lastDigits, boolean isHandshakeSuccessful, String nonce, byte[] checksum) throws NoSuchAlgorithmException {
        this.userId = userId;
